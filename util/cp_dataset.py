...
class CPDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.transform_1d = transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.5,), (0.5,))])
    ...
    def __getitem__(self, index):
        ...
        im_parse = Image.open(osp.join(self.data_path, 'image-parse', parse_name)).convert('L')
